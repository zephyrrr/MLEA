//+------------------------------------------------------------------+
//|                              ExpertCandlesStochPSARFixedRisk.mq5 |
...
//+------------------------------------------------------------------+
//--- inputs for expert
input string         Inp_Expert_Title                    ="ExpertCandlesStochPSARFixedRisk";
int                  Expert_MagicNumber                  =3503;
...
//--- inputs for money
input double         Inp_Money_FixRisk_Percent=10.0;
//+------------------------------------------------------------------+
