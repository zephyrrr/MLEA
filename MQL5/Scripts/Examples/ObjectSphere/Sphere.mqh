...
public:
   ...
   int               Parallel(void)    const { return(m_num_parallel); }
   void              Parallel(const int num) { m_num_parallel=num;     }
   int               Meridian(void)    const { return(m_num_meridian); }
   void              Meridian(const int num) { m_num_meridian=num;     }
   int               Radius(void)      const { return(m_radius);       }
   void              Radius(const int r)     { m_radius=r;             }
   int               CenterX(void)     const { return(m_center_X);     }
   void              CenterX(const int x)    { m_center_X=x;           }
   int               CenterY(void)     const { return(m_center_Y);     }
   void              CenterY(const int y)    { m_center_Y=y;           }
   //---
