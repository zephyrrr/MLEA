...
bool CChartObjectVLine::Create(long chart_id,const string name,const int window,const datetime time)
  {
   if(!ObjectCreate(chart_id,name,OBJ_VLINE,window,time,0.0)) return(false);
...
bool CChartObjectHLine::Create(long chart_id,const string name,const int window,const double price)
  {
   if(!ObjectCreate(chart_id,name,OBJ_HLINE,window,0,price)) return(false);
   if(!Attach(chart_id,name,window,1))                       return(false);
//--- succeed
   return(true);
  }
...
bool CChartObjectTrend::Create(long chart_id,const string name,const int window,
                               ...
                               const datetime time2,const double price2)
  {
   if(!ObjectCreate(chart_id,name,OBJ_TREND,window,time1,price1,time2,price2)) return(false);
...
bool CChartObjectTrendByAngle::Create(long chart_id,const string name,const int window,
                                      ...
                                      const datetime time2,const double price2)
  {
   if(!ObjectCreate(chart_id,name,OBJ_TRENDBYANGLE,window,time1,price1,time2,price2)) return(false);
   if(!Attach(chart_id,name,window,2))                                                return(false);
//--- succeed
   return(true);
  }
...
bool CChartObjectCycles::Create(long chart_id,const string name,const int window,
                                ...
                                const datetime time2,const double price2)
  {
   if(!ObjectCreate(chart_id,name,OBJ_CYCLES,window,time1,price1,time2,price2)) return(false);
   if(!Attach(chart_id,name,window,2))                                          return(false);
//--- succeed
   return(true);
  }
