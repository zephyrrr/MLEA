...
bool CChartObjectFibo::Create(long chart_id,const string name,const int window,
                              ...
                              const datetime time2,const double price2)
  {
   if(!ObjectCreate(chart_id,name,OBJ_FIBO,window,time1,price1,time2,price2)) return(false);
   if(!Attach(chart_id,name,window,2))                                        return(false);
//--- succeed
   return(true);
  }
//+------------------------------------------------------------------+
...
bool CChartObjectFiboTimes::Create(long chart_id,const string name,const int window,
                                   ...
                                   const datetime time2,const double price2)
  {
   if(!ObjectCreate(chart_id,name,OBJ_FIBOTIMES,window,time1,price1,time2,price2)) return(false);
   if(!Attach(chart_id,name,window,2))                                             return(false);
//--- succeed
   return(true);
  }
...
bool CChartObjectFiboFan::Create(long chart_id,const string name,const int window,
                                 ...
                                 const datetime time2,const double price2)
  {
   if(!ObjectCreate(chart_id,name,OBJ_FIBOFAN,window,time1,price1,time2,price2)) return(false);
   if(!Attach(chart_id,name,window,2))                                           return(false);
//--- succeed
   return(true);
  }
...
bool CChartObjectFiboArc::Create(long chart_id,const string name,const int window,
                                 ...
                                 const datetime time2,const double price2,const double scale)
  {
   if(!ObjectCreate(chart_id,name,OBJ_FIBOARC,window,time1,price1,time2,price2)) return(false);
   if(!Attach(chart_id,name,window,2))                                           return(false);
...
bool CChartObjectFiboChannel::Create(long chart_id,const string name,const int window,
                                     ...
                                     const datetime time3,const double price3)
  {
   if(!ObjectCreate(chart_id,name,OBJ_FIBOCHANNEL,window,time1,price1,time2,price2,time3,price3)) return(false);
...
bool CChartObjectFiboExpansion::Create(long chart_id,const string name,const int window,
                                       ...
                                       const datetime time3,const double price3)
  {
   if(!ObjectCreate(chart_id,name,OBJ_EXPANSION,window,time1,price1,time2,price2,time3,price3)) return(false);
   if(!Attach(chart_id,name,window,3))                                                          return(false);
//--- succeed
   return(true);
  }
