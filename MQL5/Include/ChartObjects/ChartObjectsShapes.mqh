...
bool CChartObjectRectangle::Create(long chart_id,const string name,const int window,
                                   ...
                                   const datetime time2,const double price2)
  {
   if(!ObjectCreate(chart_id,name,OBJ_RECTANGLE,window,time1,price1,time2,price2)) return(false);
...
bool CChartObjectTriangle::Create(long chart_id,const string name,const int window,
                                  ...
                                  const datetime time3,const double price3)
  {
   if(!ObjectCreate(chart_id,name,OBJ_TRIANGLE,window,time1,price1,time2,price2,time3,price3)) return(false);
...
bool CChartObjectEllipse::Create(long chart_id,const string name,const int window,
                                 ...
                                 const datetime time3,const double price3)
  {
   if(!ObjectCreate(chart_id,name,OBJ_ELLIPSE,window,time1,price1,time2,price2,time3,price3)) return(false);
   if(!Attach(chart_id,name,window,3))                                                        return(false);
//--- succeed
   return(true);
  }
