...
#define ZIGZAG_INDICATOR_COUNT 1440
...
class CZigzagPatternValue : public CObject
{
    private:
        ...
        double m_zigzagValuesHigh[ZIGZAG_INDICATOR_COUNT];
        double m_zigzagValuesLow[ZIGZAG_INDICATOR_COUNT];
        MqlTick m_mqlTick;
...
{
    m_indicatorZigzag=iCustom(Symbol(), Period(), "Examples\\ZigzagColor");
    if(m_indicatorZigzag < 0)
    {
        Alert("Error Creating Handles for indicators - error: ", GetLastError(), "!");
        return false;
    }
    bool ret = ArraySetAsSeries(m_zigzagValuesHigh, true);
    ArraySetAsSeries(m_zigzagValuesLow, true);
